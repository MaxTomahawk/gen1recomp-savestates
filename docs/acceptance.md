...
| ROM-free CI, tests, lint, reproducible package | Verified | At cross-mod audit head `6b76cbd`: 755/755 Lua checks, 7/7 Python release/package-gate checks, modkit validate/lint, two byte-identical 29-file ZIP builds plus pack manifest, and clean extracted-install validation; archive SHA-256 `f4a02c1c59ec248fab5d28121510753c6f2c573f857dcb5b0a5ce76b11a15458`; Actions run `31255626794` passes that exact head. |
