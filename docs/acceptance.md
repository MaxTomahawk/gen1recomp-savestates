...
| ROM-free CI, tests, lint, reproducible package | Verified | 740/740 Lua checks, 7/7 Python release/package-gate tests, modkit validate/lint, two byte-identical 28-file ZIP builds plus pack manifest, and fresh-clone/fresh-extracted-install checks at `4c56732`. |
